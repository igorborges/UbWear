...
public class LanguageMaps {
    ...
    private Map<String, String> createMapPt() {
        ...
        map.put("devicePaired", "Relógio pareado com sucesso. Faça login na janela acima e tente novamente!");
    ...
    private Map<String, String> createMapEn() {
        ...
        map.put("devicePaired", "Wearable device paired and app is open. Login in the window above and try again!");
        ...
        map.put("successfulConfigurationToast", "Success!!! Your watch is configured! You can close this app!");
